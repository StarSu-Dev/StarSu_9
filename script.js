...
function showRootContent() {
    ...
    cards.innerHTML = '<div class="welcome-message"><h1>StarSu | Справочник по Starfindr</h1><p>Разработано специально для ваншота в Барреле 60/5</p><p>Космические ебать приключения</p><p>Ты там клювом не щёлкай, перса создавай!</p><p>Кто не пьёт тот хуеплёт</p></div>';
